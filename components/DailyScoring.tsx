                    ...
                    <div className="flex items-center bg-white rounded-xl px-2 h-11 shadow-sm border border-transparent">
                        ...
                        <div className="relative flex items-center gap-2">
                            ...
                            <input
                                ...
                                className="border-none bg-transparent text-sm font-bold text-slate-700 focus:ring-0 cursor-pointer w-[24px] opacity-0"
                            />
                            <Calendar size={18} className="absolute right-0 text-slate-400 pointer-events-none" />
                        </div>
                        <button className="p-2 hover:bg-slate-100 rounded-lg text-slate-400 hover:text-primary transition-colors">
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                ${activeModal.type === 'violation'
                                        ...
                                        >
                                            ...
                                            <span className={`text-xs font-bold px-2 py-1 rounded-lg ${activeModal.type === 'violation'
